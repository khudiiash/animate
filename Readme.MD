...
# [CDN](https://cdn.jsdelivr.net/gh/khudiiash/animate@1.1.0/Animate.js) | [Documentation](https://docs.google.com/document/d/1dgcEFdc2rYj9XGm4GVx2okL93PnzunKSXikvOr7ADTg/edit?usp=sharing)
...
# Less code - better code
    ...
    gsap.timeline()
        ...
        .call(() => console.log('animting copy'), [], '+=1')
